    ...
    return (
      <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
          ...
          Hi, I’m Loyoh Enoch, a passionate front-end developer and digital solutions expert. I create seamless, user-friendly web experiences that empower businesses to thrive
          </p>
