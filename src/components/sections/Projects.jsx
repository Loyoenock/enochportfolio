      ...
      <section id="projects" className="min-h-screen flex items-center justify-center py-20">
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-semibold mb-2">Kosher Cuisine</h3>
              <p className="text-gray-300 mb-4">
                Software Engineering Portifolio Project based in React - Frontend Specializationat Alx/Halberton School
              </p>
              ...
              <div className="flex justify-between items-center">
                <a href="https://koshercuisine.vercel.app/" target="_" className="text-blue-400 hover:text-blue-300 transition-colors my-4">
                  View Project 
                </a>
              </div>
            </div>
